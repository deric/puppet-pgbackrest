...
define pgbackrest::cron_backup (
  ...
  Pgbackrest::CronField           $hour = 4,
  Pgbackrest::CronField           $minute = 0,
  Pgbackrest::CronField           $month = '*',
  Pgbackrest::CronField           $weekday = '*',
  Optional[Pgbackrest::CompressLevel] $compress_level = undef,
  Optional[Integer]               $archive_timeout = undef,
  Optional[Pgbackrest::CronField] $monthday = undef,
